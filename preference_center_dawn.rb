...
sleep 5
browser.goto "https://dawn-dish.com/en-us/createprofilepage"
sleep 4
...
driver.save_screenshot "Dawn/#{"About to submit register blank"}.png"


sleep 5
browser.goto "http://dawn-dish.com/en-us/loginpage"
sleep 2
browser.button(:type => 'submit').click

driver.save_screenshot "Dawn/#{"About to submit 32323234"}.png"

sleep 2

#driver.hide_keyboard
browser.goto "https://dawn-dish.com/en-us/resetpasswordpage"
puts loc1
sleep 2
#browser.a(:id =>'phsmartphonebody_0_forgotpassword').when_present.click
#browser.goto loc1
sleep 5
driver.save_screenshot "Dawn/#{"Reset_Pasword"}.png"
...
driver.save_screenshot "Dawn/#{"About to submit"}.png"
browser.button(:type => 'submit').click
...
sleep 4
driver.save_screenshot "Dawn/#{"About to submit 2"}.png"

browser.button(:type => 'submit').click

driver.save_screenshot "Dawn/#{"About to submit 3"}.png"
...
browser.button(:type => 'submit').click
sleep 4
driver.save_screenshot "Dawn/#{"About to submit 4"}.png"
sleep 4
browser.div(:class =>'pc_edit-button').when_present.click
sleep 2
driver.save_screenshot "Dawn/#{"About to submit 6"}.png"
...
driver.save_screenshot "Dawn/#{"About to submit blank"}.png"
sleep 4
driver.save_screenshot "Dawn/#{"About to submit 5"}.png"
...
driver.save_screenshot "Dawn/#{"About to submit logout"}.png"
puts "URL "<<counter
counter +=1
