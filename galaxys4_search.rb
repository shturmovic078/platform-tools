...
driver.save_screenshot  "GalaxyS4/#{"GalaxyS4_search"}.png"
...
driver.save_screenshot  "GalaxyS4/#{"GalaxyS4_sort"}.png"
puts "Go to next line or stop"
sleep 3
#Sort By Popularity
browser.link(:text =>"Popularity").when_present.click

driver.save_screenshot  "GalaxyS4/#{"Popularity"}.png"
puts "Go to next line or stop"
sleep 3
browser.a(:class => 'btn sort-btn').click
#Sort By A-Z
...
driver.save_screenshot  "GalaxyS4/#{"A_Z"}.png"
puts "Go to next line or stop"
sleep 3
browser.a(:class => 'btn sort-btn').click
#Sort By Z-A
...
driver.save_screenshot  "GalaxyS4/#{"Z_A"}.png"
puts "Go to next line or stop"
sleep 3
browser.a(:class => 'btn sort-btn').click
#Sort By A-Z
...
driver.save_screenshot  "GalaxyS4/#{"Highest Rated"}.png"
puts "Go to next line or stop"
sleep 3
#grid view
browser.a(:class => 'grid-view').click
sleep 2
driver.save_screenshot  "GalaxyS4/#{"Grid_View"}.png"
sleep 2
#Content Results
browser.a(:id =>"phsmartphonebody_0_phsmartphonetabheader_0_anchorContentResult").when_present.click
sleep 2
driver.save_screenshot  "GalaxyS4/#{"Content"}.png"

browser.goto "http://author.oralb.pgsitecore.com/en-us/search-page?term=Satin%20tape"

sleep 2

browser.div(:id =>"phsmartphonebody_0_phsmartphoneproductresults_0_RptrProductList_divAddToCart_0").when_present.click
sleep 2
driver.save_screenshot  "GalaxyS4/#{"Add_Cart"}.png"
 sleep 2

 #browser.select_list(:name, "ddlQuantity").select_value("10")

 sleep 2
driver.save_screenshot  "GalaxyS4/#{"Select_dropdown"}.png"
 sleep 3
browser.div(:class =>"btn add-to-cart").when_present.click
sleep 5
driver.save_screenshot  "GalaxyS4/#{"Added_Cart"}.png"
 sleep 5
...
browser.text_field(:name, "userContrlShoppingCartRetailerDetails$rptrRetailerDetail$ctl00$txtProductQuantity").set"2"
 ...
 sleep 2
driver.save_screenshot  "GalaxyS4/#{"update QTY"}.png"
...
driver.save_screenshot  "GalaxyS4/#{"update QTY1"}.png"
...
driver.save_screenshot  "GalaxyS4/#{"Add_Cart"}.png"
 ...
 sleep 2
driver.save_screenshot  "GalaxyS4/#{"Select_dropdown 2"}.png"
 sleep 2
browser.a(:id =>"lnkAddToCart").when_present.click
sleep 5
driver.save_screenshot  "GalaxyS4/#{"Add_Cart 2"}.png"
 sleep 5
...
browser.div(:id =>"phsmartphonebody_0_phsmartphoneproductresults_0_RptrProductList_divAddToCart_0").when_present.click
sleep 2
driver.save_screenshot  "GalaxyS4/#{"Add_Cart 3"}.png"
 sleep 2

 #browser.select_list(:id, "ddlQuantity").select_value("3")

 sleep 2
driver.save_screenshot  "GalaxyS4/#{"Select_dropdown 3"}.png"
 sleep 2
browser.a(:id =>"lnkAddToCart").when_present.click
sleep 5
driver.save_screenshot  "GalaxyS4/#{"Added_Cart 3"}.png"
 sleep 5
