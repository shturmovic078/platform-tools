...
sleep 5
browser.goto "https://bountytowels.com/en-us/Bounty-Select-a-Size/writereview"
sleep 9
...
#sleep 4
driver.save_screenshot "Bounty/#{Time.now.strftime("write_empty_%d_%m_%Y__%H_%M_%S")}.png"
...
driver.save_screenshot "Bounty/#{Time.now.strftime("write_review_popup_1_%d_%m_%Y__%H_%M_%S")}.png"

sleep 4
driver.save_screenshot "Bounty/#{Time.now.strftime("mobile_portrait_shop_products_iPhone5_1_%d_%m_%Y__%H_%M_%S")}.png"
...
driver.save_screenshot "Bounty/#{Time.now.strftime("mobile_portrait555_Preview_1_%d_%m_%Y__%H_%M_%S")}.png"
sleep 2

browser.button(:name => 'phsmartphonebody_0$ibtnSubmit').click
#driver.save_screenshot "Bounty/#{Time.now.strftime("mobile_portrait_shop_products_iPhone5_2_%d_%m_%Y__%H_%M_%S")}.png"
#sleep 4
...
driver.save_screenshot "Bounty/#{Time.now.strftime("write2_empty_%d_%m_%Y__%H_%M_%S")}.png"
...
driver.save_screenshot "Bounty/#{Time.now.strftime("write3_empty_%d_%m_%Y__%H_%M_%S")}.png"
...
driver.save_screenshot "Bounty/#{Time.now.strftime("write4_empty_%d_%m_%Y__%H_%M_%S")}.png"
...
#driver.save_screenshot "Bounty/#{Time.now.strftime("mobile_portrait_iPhone5_login1_%d_%m_%Y__%H_%M_%S")}.png"
...
#driver.save_screenshot "Bounty/#{Time.now.strftime("profile4S__%d_%m_%Y__%H_%M_%S")}.png"
