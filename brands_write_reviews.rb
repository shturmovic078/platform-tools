...
#loc4= "#{row['count']}"
sleep 25
puts "I'M ABOUT TO OPEN THE URL"
browser.goto loc1
puts loc1
#browser.goto loc1
sleep 4
browser.screenshot.save "WriteReview/#{Time.now.strftime("write_review_%d_%m_%Y__%H_%M_%S")}.png"
browser.scroll.to [0,950]
sleep 4
...
sleep 4
browser.screenshot.save "WriteReview/#{Time.now.strftime("write_review_popup_1_%d_%m_%Y__%H_%M_%S")}.png"

sleep 4
browser.screenshot.save "WriteReview/#{Time.now.strftime("mobile_portrait_shop_products_iPhone5_1_%d_%m_%Y__%H_%M_%S")}.png"
...
browser.screenshot.save "WriteReview/#{Time.now.strftime("mobile_portrait_Preview_1_%d_%m_%Y__%H_%M_%S")}.png"
...
#--------------------------------------------------------------------------------------------------------
#browser.screenshot.save "./#{Time.now.strftime("mobile_portrait_shop_products_iPhone5_2_%d_%m_%Y__%H_%M_%S")}.png"
#sleep 4
...
#browser.screenshot.save "./#{Time.now.strftime("mobile_portrait_iPhone5_login1_%d_%m_%Y__%H_%M_%S")}.png"
...
#browser.screenshot.save "./#{Time.now.strftime("profile4S__%d_%m_%Y__%H_%M_%S")}.png"
