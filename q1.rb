...
driver.navigate.to "https://author.oralb.pgsitecore.com/en-us/loginpage"
...
browser.text_field(:name => 'phsmartphonebody_0$rptProfileInformation$ctl00$txtControl').set 'QANickTester1345'
...
sleep 2
browser.checkbox(:id => 'phsmartphonebody_0_chkAgree').click
...
sleep 2
browser.select_list(:id => 'phsmartphonebody_0_rptProfileInformation_ddlControl_2').option(:value => '9').select
sleep 2
browser.select_list(:id => 'phsmartphonebody_0_rptProfileInformation_ddlControl_3').option(:value => '29').select
sleep 4
