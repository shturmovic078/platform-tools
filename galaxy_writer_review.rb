...
#loc4= "#{row['count']}"
sleep 5
browser.goto "http://author.oralb.pgsitecore.com/en-us/products/pro-health-stages-disney-fairies-toothbrush"
puts loc1
#browser.goto loc1
sleep 4
...
sleep 2 
browser.text_field(:name => 'phsmartphonebody_0$rptProductReview$ctl00$txtControlForProductReview').set 'I would like to purchase vitality-dual-clean again yeah'
browser.text_field(:name => 'phsmartphonebody_0$rptProductReview$ctl01$textareaControlForProductReview').set "Product Review 1 this is a QA product a great product again to use I repeat all of this text all over again .... This is a QA Test this is a preview of the test AQ vitality-dual-clean "
