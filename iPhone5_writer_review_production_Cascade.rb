...
#loc4= "#{row['count']}"
sleep 5
browser.goto "http://cascadeclean.com/en-us/products/by-line/cascade-gel-with-the-power-of-clorox-dishwasher-detergent-lemon-scent"
puts loc1
#browser.goto loc1
sleep 4
...
browser.select_list(:id => 'phsmartphonebody_0_rptProfileInformation_ddlControl_3').option(:text => '1978').select
sleep 4
browser.button(:name => 'phsmartphonebody_0$ibtnPreview').click
