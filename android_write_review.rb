...
sleep 2
browser.text_field(:name => 'phsmartphonebody_0$rptProductReview$ctl01$textareaControlForProductReview').set "Product Review 1 this is a QA product a great product again to use I repeat all of this text all over again .... This is a QA Test "<<"./#{Time.now.strftime("mobile_portrait_Preview_1_%d_%m_%Y__%H_%M_%S")}"
