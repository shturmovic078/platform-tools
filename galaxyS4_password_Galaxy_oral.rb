...
driver.save_screenshot "GalaxyS4/#{"About to submit register blank"}.png"
...
driver.save_screenshot "GalaxyS4/#{"About to submit 32323234"}.png"
...
#browser.goto loc1
sleep 5
driver.save_screenshot "GalaxyS4/#{"Reset_Pasword"}.png"
...
driver.save_screenshot "GalaxyS4/#{"About to submit"}.png"
browser.button(:type => 'submit').click
...
sleep 4
driver.save_screenshot "GalaxyS4/#{"About to submit 2"}.png"

browser.button(:type => 'submit').click

driver.save_screenshot "GalaxyS4/#{"About to submit 3"}.png"
...
browser.button(:type => 'submit').click
sleep 4
driver.save_screenshot "GalaxyS4/#{"About to submit 4"}.png"
sleep 4
browser.div(:class =>'pc_edit-button').when_present.click
sleep 2
driver.save_screenshot "GalaxyS4/#{"About to submit 6"}.png"
...
driver.save_screenshot "GalaxyS4/#{"About to submit blank"}.png"
sleep 4
driver.save_screenshot "GalaxyS4/#{"About to submit 5"}.png"
...
driver.save_screenshot "GalaxyS4/#{"About to submit logout"}.png"
puts "URL "<<counter
counter +=1
