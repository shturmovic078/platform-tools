...
driver.save_screenshot  "iPhone5/#{"iPhone5_search"}.png"
...
driver.save_screenshot  "iPhone5/#{"iPhone5_sort"}.png"
puts "Go to next line or stop"
sleep 3
#Sort By Popularity
browser.link(:text =>"Popularity").when_present.click

driver.save_screenshot  "iPhone5/#{"Popularity"}.png"
puts "Go to next line or stop"
sleep 3
browser.a(:class => 'btn sort-btn').click
#Sort By A-Z
...
driver.save_screenshot  "iPhone5/#{"A_Z"}.png"
puts "Go to next line or stop"
sleep 3
browser.a(:class => 'btn sort-btn').click
#Sort By Z-A
...
driver.save_screenshot  "iPhone5/#{"Z_A"}.png"
puts "Go to next line or stop"
sleep 3
browser.a(:class => 'btn sort-btn').click
#Sort By A-Z
...
driver.save_screenshot  "iPhone5/#{"Highest Rated"}.png"
puts "Go to next line or stop"
sleep 3
#grid view
browser.a(:class => 'grid-view').click
sleep 2
driver.save_screenshot  "iPhone5/#{"Grid_View"}.png"
sleep 2
#Content Results
browser.a(:id =>"phsmartphonebody_0_phsmartphonetabheader_0_anchorContentResult").when_present.click
sleep 2
driver.save_screenshot  "iPhone5/#{"Content"}.png"
...
sleep 2
driver.save_screenshot  "iPhone5/#{"Add_Cart"}.png"
