...
csv_text = File.read('oral_search.csv')
...
puts "8 to add"
sleep 8
driver.save_screenshot driver.title<<"_galaxyS31_landscape.png"
puts "8 to add"
sleep 8
driver.save_screenshot driver.title<<"_galaxyS32_landscape.png"
