...
sleep 5
browser.goto "https://cascadeclean.com/en-us/create-profile"
sleep 4
puts "Here I'm"
...
driver.save_screenshot "Cascade/#{"About to submit register blank"}.png"


sleep 5
browser.goto "https://www.cascadeclean.com/en-us/loginpage"
sleep 2
browser.button(:type => 'submit').click

driver.save_screenshot "Cascade/#{"About to submit 32323234"}.png"

sleep 2

#driver.hide_keyboard
browser.goto "https://cascadeclean.com/en-us/resetpasswordpage"
puts loc1
sleep 2
#browser.a(:id =>'phsmartphonebody_0_forgotpassword').when_present.click
#browser.goto loc1
sleep 5
driver.save_screenshot "Cascade/#{"Reset_Pasword"}.png"
...
driver.save_screenshot "Cascade/#{"About to submit"}.png"
browser.button(:type => 'submit').click
...
sleep 4
driver.save_screenshot "Cascade/#{"About to submit 2"}.png"

browser.button(:type => 'submit').click

driver.save_screenshot "Cascade/#{"About to submit 3"}.png"
...
browser.button(:type => 'submit').click
sleep 4
driver.save_screenshot "Cascade/#{"About to submit 4"}.png"
sleep 4
browser.div(:class =>'pc_edit-button').when_present.click
sleep 2
driver.save_screenshot "Cascade/#{"About to submit 6"}.png"
sleep 2
...
driver.save_screenshot "Cascade/#{"About to submit blank"}.png"
sleep 4
driver.save_screenshot "Cascade/#{"About to submit 5"}.png"
...
driver.save_screenshot "Cascade/#{"About to submit logout"}.png"
puts "URL "<<counter
counter +=1
